/*
* Description:
Closing section with navigation links and social media handles.

Purpose:
Provide credibility, compliance, and ways to connect.
* */

const navigation = {
    solutions: [
        { name: 'LMG Platform', href: '#' },
        { name: 'Optics', href: '#' },
...
// Placeholder social icons - you can replace these with actual icons from a library like react-icons
const social = [
    {
        name: 'X',
        href: '#',
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        ...
                        <p className="text-3xl font-bold text-white">LMG Showcase</p>
                        <p className="text-sm leading-6 text-gray-300">
                            Providing elite tactical solutions for modern defense challenges.
                        </p>
                    </div>
